This project features a simple car model with combustion engine and 5 stage gearbox. The goal is to find optimal shifting times for the gearbox for two scenarios.
## Scenarios

1. **Straight line**: Find shifting points that maximize travelled distance
2. **Straight line-Curve-Straight line**: Find shifting and braking points, that maximize travelled distance, with additional constraint on speed during curve


## Car model
Car is modelled as a Mixed Logical Dynamical system, governed by differential equations and constraints:
